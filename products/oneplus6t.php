...
<div class="mySlides fade">
  ...
  <figure>
  <img class="img" src="../assets/img/oneplus6t.png" style="width:70%" alt="oneplus">
...
<div class="mySlides fade">
  ...
  <figure>
  <img class="img" src="../assets/img/oneplus6t-2.png" style="width:35%" alt="oneplus">
...
<div class="mySlides fade">
  ...
  <figure>
  <img class="img" src="../assets/img/oneplus6t-3.png" style="width:48%" alt="oneplus">
  <figcaption><p class="text">Back</p></figcaption>
  </figure>
</div>
...
<br>
<?php
$productsql = "SELECT product.price AS productPrice FROM product WHERE product.active = 1 AND product.product_id = 8";
...
<div class="detailtext">
    ...
    <p>Resolution: 1080 x 2340<br>
    Size: 6.41 inches<br>
    OS: Android<br>
    Chipset: Qualcomm SDM845 Snapdragon 845 (10 nm)<br>
    CPU: Octa-core<br>
    GPU: Adreno 630<br>
    RAM: 6GB or 8GB<br>
...
<input type="hidden" name="item_name" value="OnePlus 6T"> <!-- Change product name!-->
